;(function($) {
    ...
    var Notification = function(container, options) {
        ...
        self.options = $.extend(true, {}, $.fn.dnNotification.defaults, options);
        ...
        if (!self.container.find('.pgn-wrapper[data-position=' + this.options.position + ']').length) {
            ...
            self.wrapper = self.container.find('.pgn-wrapper[data-position=' + this.options.position + ']');
        }
    ...
    $.fn.dnNotification = function(options) {
        return new Notification(this, options);
    };

    $.fn.dnNotification.defaults = {
        style: 'simple',
        message: null,
        position: 'top-right',
        type: 'info',
