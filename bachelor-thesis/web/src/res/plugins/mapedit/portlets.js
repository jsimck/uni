;(function($) {
    ...
    var Portlet = function(element, options) {
        ...
        this.$heading = this.$element.find('.panel-heading');
    };
    Portlet.VERSION = "1.0.0";

    Portlet.prototype.collapseClean = function () {
        this.$body.removeAttr('data-orig-padding-top');
        this.$body.removeAttr('data-orig-padding-bottom');
        this.$body.removeAttr('data-orig-height');
    ...
    Portlet.prototype.collapse = function() {
        ...
        if (this.$element.hasClass('panel-collapsed')) {
            ...
            var paddingTop = this.$body.data('orig-padding-top');
            var paddingBottom = this.$body.data('orig-padding-bottom');
            var height = this.$body.data('orig-height');

            if (this.$heading.attr('data-origin-separator') == 'true') {
                this.$heading.addClass('separator');
                this.$heading.removeAttr('data-origin-separator')
            }
            ...
            }, 500, 'easeOutCubic', this.collapseClean.bind(this));

            $.isFunction(this.options.onExpand) && this.options.onExpand();
        } else {
            this.$body.attr('data-orig-padding-top', this.$body.css('padding-top'));
            this.$body.attr('data-orig-padding-bottom', this.$body.css('padding-bottom'));
            this.$body.attr('data-orig-height', this.$body.outerHeight() + 'px');
            this.$body.css('height', this.$body.outerHeight());
            ...
            this.$body.velocity({
                ...
                this.$body.hide(0);
                if (this.$heading.hasClass('separator')) {
                    this.$heading.attr('data-origin-separator', 'true');
                    this.$heading.removeClass('separator');
                }
            }.bind(this));
    ...
    $(window).on('load', function() {
        $('[data-init-plugin="portlet"]').each(function() {
            var $portlet = $(this);
